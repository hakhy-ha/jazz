    ...
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 text-white">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-3xl border border-white/10 bg-surface p-6 shadow-xl">
        ...
        <div className="text-right">
          <Link href="/auth/forgot-password" className="text-sm text-lime-300 hover:text-lime-200">Forgot password?</Link>
        </div>
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-surface px-2 text-white/70">Or continue with</span>
          </div>
        </div>
        <button
          type="button"
          ...
          disabled={isSubmitting}
          className="w-full rounded-full border border-white/10 bg-[#1a0f0d] px-5 py-3 font-semibold text-white hover:bg-[#2a1f1d] transition-colors disabled:cursor-not-allowed disabled:opacity-60"
        >
